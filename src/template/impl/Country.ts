    ...
    getContent(): Record<string, Field[]> {
        return {
            "general": [
                ...
                new Field("leaders", "Leaders", FieldType.Text, "Who were the previous leaders and who is the current one")
            ], "economics": [
                ...
                new Field("free", "", FieldType.Document, "Anything else to add? How camembert used to be the national cheese? Or just some personal notes you don't want to forget?"),
            ]
        };
    }
